...
export class InventoriesAPI extends BaseAPI {
   ...
   async filter (query?: { filter?: string, sort?: string, limit?: number, offset?: number, storeKey?: string, currencyCode?: string, languageCode?: string, priceListKey?: string, time?: number, merchantKey?: string, expand?: string, project?: string }): Promise<InventoryFilterResultDTO> {
       const response = await this._request({
           path: `/merchandise/inventories`,
           method: 'GET',
   ...
   async search (query?: { sort?: string, limit?: number, offset?: number, language?: string, term?: string, phrase?: string, storeKey?: string, currencyCode?: string, languageCode?: string, priceListKey?: string, time?: number, merchantKey?: string, expand?: string, project?: string }): Promise<InventorySearchResultDTO> {
       const response = await this._request({
